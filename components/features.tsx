...
import { FileText, Brain, Sparkles, MessageSquare, Bot, Zap, ArrowRight } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">AI Power</span>
          </h2>
